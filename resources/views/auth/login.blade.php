<x-guest-layout>
    ...
    <form
        ...
        <div>
            ...
            <x-text-input x-model="email" id="email" class="block mt-1 w-full" type="email" name="email" :value="old
            ('email')"
        ...
        <div class="flex items-center justify-end mt-4">
            @if (Route::has('password.request'))
                <a x-show="showPasswordField" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md
                focus:outline-none
